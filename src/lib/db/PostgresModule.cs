...
public class PostgresModule : AbstractQuercusModule {
  ...
  public const int PGSQL_BOTH = 0x03;
  public const int PGSQL_CONNECT_FORCE_NEW = 0x04;
  public const int PGSQL_CONNECTION_BAD = 0x05;
  public const int PGSQL_CONNECTION_OK = 0x06;
  public const int PGSQL_SEEK_SET = 0x07;
  public const int PGSQL_SEEK_CUR = 0x08;
  public const int PGSQL_SEEK_END = 0x09;
  public const int PGSQL_EMPTY_QUERY = 0x0A;
  public const int PGSQL_COMMAND_OK = 0x0B;
  public const int PGSQL_TUPLES_OK = 0x0C;
  public const int PGSQL_COPY_OUT = 0x0D;
  public const int PGSQL_COPY_IN = 0x0E;
  public const int PGSQL_BAD_RESPONSE = 0x0F;
  public const int PGSQL_NONFATAL_ERROR = 0x10;
  public const int PGSQL_FATAL_ERROR = 0x11;
  public const int PGSQL_TRANSACTION_IDLE = 0x12;
  public const int PGSQL_TRANSACTION_ACTIVE = 0x13;
  public const int PGSQL_TRANSACTION_INTRANS = 0x14;
  public const int PGSQL_TRANSACTION_INERROR = 0x15;
  public const int PGSQL_TRANSACTION_UNKNOWN = 0x16;
  public const int PGSQL_DIAG_SEVERITY = 0x17;
  public const int PGSQL_DIAG_SQLSTATE = 0x18;
  public const int PGSQL_DIAG_MESSAGE_PRIMARY = 0x19;
  public const int PGSQL_DIAG_MESSAGE_DETAIL = 0x20;
  public const int PGSQL_DIAG_MESSAGE_HINT = 0x21;
  public const int PGSQL_DIAG_STATEMENT_POSITION = 0x22;
  public const int PGSQL_DIAG_INTERNAL_POSITION = 0x23;
  public const int PGSQL_DIAG_INTERNAL_QUERY = 0x24;
  public const int PGSQL_DIAG_CONTEXT = 0x25;
  public const int PGSQL_DIAG_SOURCE_FILE = 0x26;
  public const int PGSQL_DIAG_SOURCE_LINE = 0x27;
  public const int PGSQL_DIAG_SOURCE_FUNCTION = 0x28;
  public const int PGSQL_ERRORS_TERSE = 0x29;
  public const int PGSQL_ERRORS_DEFAULT = 0x2A;
  public const int PGSQL_ERRORS_VERBOSE = 0x2B;
  public const int PGSQL_STATUS_LONG = 0x2C;
  public const int PGSQL_STATUS_STRING = 0x2D;
  public const int PGSQL_CONV_IGNORE_DEFAULT = 0x2E;
  public const int PGSQL_CONV_FORCE_NULL = 0x2F;
