...
public class SocketModule extends AbstractQuercusModule {
  ...
  private const int SOCK_RDM = 4;
  private const int MSG_OOB = 1;
  private const int MSG_WAITALL = 256;
  private const int MSG_PEEK = 2;
  private const int MSG_DONTROUTE = 4;
  private const int SO_DEBUG = 1;
  private const int SO_REUSEADDR = 2;
  private const int SO_KEEPALIVE = 9;
  private const int SO_DONTROUTE = 5;
  private const int SO_LINGER = 13;
  private const int SO_BROADCAST = 6;
  private const int SO_OOBINLINE = 10;
  private const int SO_SNDBUF = 7;
  private const int SO_RCVBUF = 8;
  private const int SO_SNDLOWAT = 19;
  private const int SO_RCVLOWAT = 18;
  private const int SO_SNDTIMEO = 21;
  private const int SO_RCVTIMEO = 20;
  private const int SO_TYPE = 3;
  private const int SO_ERROR = 4;
  private const int SOL_SOCKET = 1;
  private const int SOMAXCONN = 128;
  private const int PHP_NORMAL_READ = 1;
  private const int PHP_BINARY_READ = 2;
  private const int SOCKET_EPERM = 1;
  private const int SOCKET_ENOENT = 2;
  private const int SOCKET_EINTR = 4;
  private const int SOCKET_EIO = 5;
  private const int SOCKET_ENXIO = 6;
  private const int SOCKET_E2BIG = 7;
  private const int SOCKET_EBADF = 9;
  private const int SOCKET_EAGAIN = 11;
  private const int SOCKET_ENOMEM = 12;
  private const int SOCKET_EACCES = 13;
  private const int SOCKET_EFAULT = 14;
  private const int SOCKET_ENOTBLK = 15;
  private const int SOCKET_EBUSY = 16;
  private const int SOCKET_EEXIST = 17;
  private const int SOCKET_EXDEV = 18;
  private const int SOCKET_ENODEV = 19;
  private const int SOCKET_ENOTDIR = 20;
  private const int SOCKET_EISDIR = 21;
  private const int SOCKET_EINVAL = 22;
  private const int SOCKET_ENFILE = 23;
  private const int SOCKET_EMFILE = 24;
  private const int SOCKET_ENOTTY = 25;
  private const int SOCKET_ENOSPC = 28;
  private const int SOCKET_ESPIPE = 29;
  private const int SOCKET_EROFS = 30;
  private const int SOCKET_EMLINK = 31;
  private const int SOCKET_EPIPE = 32;
  private const int SOCKET_ENAMETOOLONG = 36;
  private const int SOCKET_ENOLCK = 37;
  private const int SOCKET_ENOSYS = 38;
  private const int SOCKET_ENOTEMPTY = 39;
  private const int SOCKET_ELOOP = 40;
  private const int SOCKET_EWOULDBLOCK = 11;
  private const int SOCKET_ENOMSG = 42;
  private const int SOCKET_EIDRM = 43;
  private const int SOCKET_ECHRNG = 44;
  private const int SOCKET_EL2NSYNC = 45;
  private const int SOCKET_EL3HLT = 46;
  private const int SOCKET_EL3RST = 47;
  private const int SOCKET_ELNRNG = 48;
  private const int SOCKET_EUNATCH = 49;
  private const int SOCKET_ENOCSI = 50;
  private const int SOCKET_EL2HLT = 51;
  private const int SOCKET_EBADE = 52;
  private const int SOCKET_EBADR = 53;
  private const int SOCKET_EXFULL = 54;
  private const int SOCKET_ENOANO = 55;
  private const int SOCKET_EBADRQC = 56;
  private const int SOCKET_EBADSLT = 57;
  private const int SOCKET_ENOSTR = 60;
  private const int SOCKET_ENODATA = 61;
  private const int SOCKET_ETIME = 62;
  private const int SOCKET_ENOSR = 63;
  private const int SOCKET_ENONET = 64;
  private const int SOCKET_EREMOTE = 66;
  private const int SOCKET_ENOLINK = 67;
  private const int SOCKET_EADV = 68;
  private const int SOCKET_ESRMNT = 69;
  private const int SOCKET_ECOMM = 70;
  private const int SOCKET_EPROTO = 71;
  private const int SOCKET_EMULTIHOP = 72;
  private const int SOCKET_EBADMSG = 74;
  private const int SOCKET_ENOTUNIQ = 76;
  private const int SOCKET_EBADFD = 77;
  private const int SOCKET_EREMCHG = 78;
  private const int SOCKET_ERESTART = 85;
  private const int SOCKET_ESTRPIPE = 86;
  private const int SOCKET_EUSERS = 87;
  private const int SOCKET_ENOTSOCK = 88;
  private const int SOCKET_EDESTADDRREQ = 89;
  private const int SOCKET_EMSGSIZE = 90;
  private const int SOCKET_EPROTOTYPE = 91;
  private const int SOCKET_ENOPROTOOPT = 92;
  private const int SOCKET_EPROTONOSUPPORT = 93;
  private const int SOCKET_ESOCKTNOSUPPORT = 94;
  private const int SOCKET_EOPNOTSUPP = 95;
  private const int SOCKET_EPFNOSUPPORT = 96;
  private const int SOCKET_EAFNOSUPPORT = 97;
  private const int SOCKET_EADDRINUSE = 98;
  private const int SOCKET_EADDRNOTAVAIL = 99;
  private const int SOCKET_ENETDOWN = 100;
  private const int SOCKET_ENETUNREACH = 101;
  private const int SOCKET_ENETRESET = 102;
  private const int SOCKET_ECONNABORTED = 103;
  private const int SOCKET_ECONNRESET = 104;
  private const int SOCKET_ENOBUFS = 105;
  private const int SOCKET_EISCONN = 106;
  private const int SOCKET_ENOTCONN = 107;
  private const int SOCKET_ESHUTDOWN = 108;
  private const int SOCKET_ETOOMANYREFS = 109;
  private const int SOCKET_ETIMEDOUT = 110;
  private const int SOCKET_ECONNREFUSED = 111;
  private const int SOCKET_EHOSTDOWN = 112;
  private const int SOCKET_EHOSTUNREACH = 113;
  private const int SOCKET_EALREADY = 114;
  private const int SOCKET_EINPROGRESS = 115;
  private const int SOCKET_EISNAM = 120;
  private const int SOCKET_EREMOTEIO = 121;
  private const int SOCKET_EDQUOT = 122;
  private const int SOCKET_ENOMEDIUM = 123;
  private const int SOCKET_EMEDIUMTYPE = 124;
